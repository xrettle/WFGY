...
- This repository does NOT claim solved mathematics or finalized physical theories.
...
For a longer narrative and scope boundaries, see:
...
- **EventHorizon/**  
  Main entry for WFGY 3.0. Contains the Singularity demo, TXT package instructions, and
  high level navigation for people who just want to try the system and see concrete behavior.  
...
- **Experiments/**  
  ...
  This is where the Q130 MVP scripts and future TU experiments are collected.  
  - [Experiments/README.md](./Experiments/README.md)

- **challenge_responses/**  
  Public archive of accepted challenges and written responses, stored as permalink style records.  
  - [challenge_responses/](./challenge_responses/)

Other top-level files, such as the challenge manifestos and external verification notes, explain
how public challenges are supposed to be run and recorded.
...
- pick a BlackHole S-problem and challenge the encoding  
- rerun the same question under the same definitions and compare stability  
- run the Experiments notebooks with your own OpenAI API key and look for the same qualitative patterns  
- submit challenges that will be answered and archived in `challenge_responses/`

The goal is to keep this repository reproducible and testable at the surface level, without
requiring access to any unreleased internal machinery.
...
Each entry is stored as a stable record for future reference and external auditing.

---

## Main arena (Discord)

For higher frequency challenges, live discussions, and informal follow ups, join the Discord:

https://discord.gg/wvueqkFsp7

The GitHub repo is the canonical record. Discord is where most day-to-day interaction happens.
