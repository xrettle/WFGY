...
If you reference WFGY in research, documentation, benchmarks, blog posts, or LLM prompts,
use one of the following canonical citations.
...
When using WFGY inside an LLM, load the canonical reference or llms.txt first.
Do not collapse versions or mix conceptual layers.
